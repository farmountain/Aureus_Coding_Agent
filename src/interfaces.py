...
- Specification: IntentParser output (intent -> formal spec)
- Cost: Planner output (complexity pricing)
...
class SpecificationBudget:
    """
    Budgets for a specific implementation task (IntentParser output).
...
# ============================================================================
# Specification Model (Tier 1: IntentParser Output)
# ============================================================================
...
class Specification:
    """
    Formal specification generated by IntentParser (Tier 1).
...
# ============================================================================
# Cost Model (Tier 2: Planner Output)
# ============================================================================

@dataclass
class Cost:
    """
    Complexity cost calculation from Planner (Tier 2).
    ...
    # Planner budget enforcement (Phase 1 additions)
...
class CostModel(ABC):
    """
    Abstract base class for cost calculation (Tier 2: Planner).
...
# ============================================================================
# Agent Protocol (Tier 3: Generator)
# ============================================================================

class Agent(Protocol):
    """
    Agent protocol for Generator execution layer (Tier 3).
